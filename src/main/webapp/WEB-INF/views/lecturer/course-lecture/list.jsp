...
<acme:list>
	...
	<acme:list-column code="lecturer.lecture.list.label.summary" path="summary"/>
	<acme:list-column code="lecturer.lecture.list.label.estimatedLearningTime" path="estimatedLearningTime"/>
</acme:list>
