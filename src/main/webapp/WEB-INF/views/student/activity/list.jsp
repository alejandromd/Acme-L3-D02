...
<acme:list>
	...
	<acme:list-column code="student.activity.list.label.startDate" path="startPeriod" width="25%"/>
	<acme:list-column code="student.activity.list.label.endDate" path="endPeriod" width="25%"/>
</acme:list>
