...
<acme:form>
	...
	<acme:input-textbox code="authenticated.course.form.label.summary" path="summary"/>	
	...
	<acme:input-textbox code="authenticated.course.form.label.almaMater" path="almaMater"/>	
	<acme:input-textbox code="authenticated.course.form.label.courseType" path="courseType"/>
	<acme:input-textbox code="authenticated.course.form.label.lecture" path="lecture"/>
</acme:form>