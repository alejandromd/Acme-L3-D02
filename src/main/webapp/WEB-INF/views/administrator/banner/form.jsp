...
<acme:form>
	...
	<acme:input-url code="administrator.banner.form.label.target" path="linkWeb"/>
	
	<jstl:choose>
		<jstl:when test="${acme:anyOf(_command, 'show|update|delete')}">
			<acme:submit test="${isViewable}" code="administrator.banner.form.button.update" action="/administrator/banner/update"/>
			<acme:submit test="${isViewable}" code="administrator.banner.form.button.delete" action="/administrator/banner/delete"/>
			<jstl:choose>
				<jstl:when test="${!isViewable}">
					<acme:message  code="administrator.banner.form.notEditable"/>
				</jstl:when>
			</jstl:choose>
		</jstl:when>
